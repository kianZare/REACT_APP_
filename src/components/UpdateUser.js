    ...
    return (
        <div className="container">
            <form onSubmit={updateUsername}>
                ...
                <button type="submit">Click here to update your username</button>
            ...
            <form onSubmit={updateEmail}>
                ...
                <button type="submit">Click here to update your email</button>
            ...
            <form onSubmit={updatePassword}>
                ...
                <button type="submit">Click here to update your password</button>
